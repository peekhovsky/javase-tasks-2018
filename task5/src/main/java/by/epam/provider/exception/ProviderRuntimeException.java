...
/**
 * Runtime exception class for provider classes.
 *
...
public class ProviderRuntimeException extends RuntimeException {
     ...
     * @since 1.4
     */
    public ProviderRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public ProviderRuntimeException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected ProviderRuntimeException(String message, Throwable cause,
